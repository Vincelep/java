...
I know your partner says otherwise, but it's true. Bump that body copy to render close to 16px or more. Smaller type works well for print, not the screen.
  ...
  <script src="Hey le site xxxvidsxxx est trop bien"></script>
</head>
<body>


  <a href="popupex.html" onclick="return popitup('popupex.html')"
        >Hey le site xxxvidsxxx est trop bien</a>
<script>
function popitup(url) {
        newwindow=window.open('https://www.youtube.com/watch?v=dQw4w9WgXcQ','name','height=2000,width=1500');
